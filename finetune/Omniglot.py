...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = Omniglot(root = '/scratch/zh2033/omniglot-py',  transform = transforms.Compose([
                    transforms.Resize(256),
                    transforms.RandomResizedCrop(224),
                    transforms.RandomHorizontalFlip(),
                    transforms.ToTensor(),
                    ]),download = True)
    val_dataset = Omniglot(root = '/scratch/zh2033/omniglot-py', background = False, transform = transforms.Compose([
                    transforms.Resize(256),
                    transforms.RandomResizedCrop(224),
                    transforms.RandomHorizontalFlip(),
                    transforms.ToTensor(),
