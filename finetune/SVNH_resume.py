...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = SVHN(root = '/scratch/zh2033/SVNH',  transform = transforms.Compose([
                    transforms.Resize(256),
                    transforms.RandomResizedCrop(224),
                    transforms.RandomHorizontalFlip(),
                    transforms.ToTensor(),
                    ]),download = True)
    val_dataset = SVHN(root = '/scratch/zh2033/SVNH', split = 'test', transform = transforms.Compose([
                    transforms.Resize(256),
                    transforms.RandomResizedCrop(224),
                    transforms.RandomHorizontalFlip(),
                    transforms.ToTensor(),
